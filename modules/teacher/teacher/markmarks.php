...
if(isset($_SESSION['id']) && isset($_SESSION['username'])){
    ...
    if($status == 'yes' || $status == 'Yes') {
        ...
        <head>
            ...
            <title>Mark Marks-Teachers-CIMS</title>
            ...
            <form method="post">
                <table border="2px" cellpadding="7px">
                    ...
                    <?php while ($rows = mysqli_fetch_assoc($sql_search_student_check)){
                        ...
                        ?>
                        <tr>
                            <td><input class="no" type="text" name="sid" value="<?php echo $sid_get;  ?>" disabled></td>
                            <td><input class="no" type="text" name="name" value="<?php echo $name_get; ?>" disabled></td>
                            <td><input class="no" type="text" name="marksobtain[<?php echo $sid_get?>]" placeholder="Obtained Marks"></td>
                        </tr>
